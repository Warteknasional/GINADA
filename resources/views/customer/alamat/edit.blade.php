...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <h2 class="text-2xl font-bold mb-6">Edit Alamat</h2>
        
        <form action="{{ route('customer.alamat.update', $alamat) }}" method="POST">
            @csrf
            @method('PUT')

            <div class="mb-4">
                <label for="judul" class="block text-sm font-medium text-gray-700 mb-2">Label Alamat</label>
                <input type="text" name="judul" id="judul" value="{{ old('judul', $alamat->judul) }}" 
            ...
            <div class="mb-4">
                ...
                <input type="text" name="penerima" id="penerima" value="{{ old('penerima', $alamat->penerima) }}" 
            ...
            <div class="mb-4">
                ...
                <input type="text" name="no_hp" id="no_hp" value="{{ old('no_hp', $alamat->no_hp) }}" 
            ...
            <div class="mb-4">
                ...
                <textarea name="alamat_lengkap" id="alamat_lengkap" rows="3" 
                          ...
                          class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 @error('alamat_lengkap') border-red-500 @enderror" required>{{ old('alamat_lengkap', $alamat->alamat_lengkap) }}</textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <input type="text" name="kota" id="kota" value="{{ old('kota', $alamat->kota) }}" 
                ...
                <div>
                    ...
                    <input type="text" name="provinsi" id="provinsi" value="{{ old('provinsi', $alamat->provinsi) }}" 
            ...
            <div class="mb-4">
                ...
                <input type="text" name="kode_pos" id="kode_pos" value="{{ old('kode_pos', $alamat->kode_pos) }}" 
                       class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
